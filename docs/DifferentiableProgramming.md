...
both `Differentiable` and `AdditiveArithmetic`.
...
@derivative(of: foo)
func foo<T: Differentiable>(_ x: T, _ y: T, _ z: T) -> (
    value: T, 
    differential: (T.TangentVector, T.TangentVector, T.TangentVector) -> T.TangentVector
) {
    ...
}
...
func foo<T: Differentiable>(_ x: T, _ y: T, _ z: T) -> (
    value: T, 
    differential: (T.TangentVector) -> T.TangentVector
) {
    ...
}
...
public func _(_ x: Float) -> (
    value: Float, 
    differential: @differential(linear) (Float) -> Float
) {
